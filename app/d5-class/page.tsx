  ...
  <span className="hero-line hero-point">설득용 이미지다</span>
      ...
      <section className="question-section">
        ...
        <p className="section-lead">
          ...
          멋진 그림을 만드는 일이 아닙니다.<br /> 내가 설계한 건물의 의도, 분위기,
          장점, 공간감을 정확히 보여주는 일입니다.
        </p>
      ...
      <section className="story-section light">
        ...
        <p>
          ...
          보이는 각도와 분위기를 선택하는 일입니다.
        </p>
        <p>
          같은 모델이어도 어떤 카메라를 잡는지, 어떤 시간대의 빛을 쓰는지, 어떤
          재질감을 강조하는지에 따라 이미지는 전혀 다른 설득력을 갖게 됩니다.
        </p>
        <p>
          그래서 이 수업에서는 D5 기능을 배우기 전에, 먼저 좋은 건축 이미지를
          보는 기준부터 함께 잡습니다.
        </p>
      </section>
      ...
      <section className="story-section dark">
        ...
        <p>
          ...
          포장지가 아니라, 설계를 이해시키고 설득시키는 중요한 과정입니다.
        </p>
        <p>
          이 클래스에서는 단순히 예쁜 장면을 만드는 것이 아니라, 내가 의도한
          디자인 포인트가 이미지 안에서 살아나도록 만드는 방법을 배웁니다.
        </p>
      </section>

      <section className="story-section light">
        <p className="eyebrow">PART 03</p>
        <h2>그래서 결과물을 남기는<br /> 수업으로 만들었습니다.</h2>
        <p>
          초급반에서는 D5를 처음 켜는 분도 따라올 수 있도록 인터페이스, 카메라,
          재질, 빛, 사람과 나무 배치까지 다룹니다. 수업의 목표는 단 하나,
          투시도 한 장을 완성하는 것입니다.
        </p>
        <p>
          중급반에서는 조감도를 중심으로 더 넓은 장면을 다룹니다. 사이트의
          분위기, 주변 환경, 스케일감, 날씨와 시간대까지 조절하며 포트폴리오에
          넣을 수 있는 이미지를 완성합니다.
        </p>
      </section>
