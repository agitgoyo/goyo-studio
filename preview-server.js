...
function renderWorks() {
  return works
    .map(
      (work) => `
        <article class="project ${work.variant}">
          <div class="thumb">
            <img src="${work.image}" alt="${work.imageAlt}" />
          </div>
          <div class="project-body">
            <div class="project-meta">${work.category}</div>
            <h3>${work.title}</h3>
    ...
    .map(
      (service) => `
        <article class="service">
          <img class="service-image" src="${service.image}" alt="${service.imageAlt}" />
          <div class="service-content">
            ...
            <a class="service-link" href="${service.href}">${service.label}</a>
          </div>
        </article>
      `
    )
...
<head>
  ...
  <title>GOYO STUDIO Preview</title>
  <style>
    :root {
      --bg: #f4f1eb;
      --paper: #fffaf2;
...
<body>
  <header class="site-header">
    <div class="wrap nav">
      <a class="logo" href="/">GOYO STUDIO</a>
      <nav class="nav-links">
  ...
  <main>
    <section class="hero">
      <div class="wrap hero-grid">
        <div>
          <div class="eyebrow">Architect · Visualizer · Educator</div>
          ...
          <div class="hero-actions">
            <a class="btn primary" href="#works">포트폴리오 보기</a>
            <a class="btn" href="#services">서비스 보기</a>
          </div>
        </div>

        <div class="hero-visual">
          <img class="hero-image" src="/images/hero-main.jpg" alt="GOYO STUDIO 대표 이미지" />
          <div class="hero-gradient"></div>
          <div class="hero-title-stack">Design with<br />quiet intensity</div>
        </div>
      </div>
    </section>
    ...
    <section class="intro">
      <div class="wrap intro-grid">
        <div class="intro-title">생각은 구조로,<br />구조는 이미지로.</div>
        <div>
          <div class="intro-copy">
            건축은 결국 무엇을 보이게 할지 정하는 일이라고 믿습니다. 고요 스튜디오는 개념의 방향,
            공간의 분위기, 설계의 핵심을 또렷하게 읽히는 시각 언어로 풀어냅니다.
          </div>
          <div class="keyword-row">
            <span class="keyword">Architecture Design</span>
            <span class="keyword">Concept Planning</span>
            <span class="keyword">3D Visualization</span>
            <span class="keyword">SketchUp · D5</span>
      ...
      <div class="wrap">
        <div class="section-head">
          <div class="works-title-row">
            ...
            <a class="more-portfolio-btn" href="https://agit-goyo.myportfolio.com/" target="_blank" rel="noreferrer">MORE PORTFOLIO</a>
          </div>
        </div>
        <div class="project-grid">${renderWorks()}</div>
      </div>
    </section>
    ...
    <section id="services" class="services">
      <div class="wrap">
        <div class="section-head">
          <h2>SERVICES</h2>
          <p>강의, 자료, 이미지 제작까지 건축 시각화 작업에 필요한 흐름을 한 스튜디오 안에서 연결합니다.</p>
        </div>
    ...
    <section id="profile">
      <div class="wrap profile-grid">
        <div class="profile-card">
          <h2>About<br />GOYO</h2>
          <p>
            건축 실무와 시각화 작업을 함께 다뤄온 경험을 바탕으로, 설계의 의도와 이미지를 자연스럽게 연결하는 일을 합니다.
            보기 좋은 그림보다 전달력 있는 장면을 더 중요하게 생각합니다.
          </p>
          <p>
            인스타그램 <strong>@agit_goyo</strong>를 통해 SketchUp, D5 Render, 건축 이미지 제작 과정을 나누며
            건축을 공부하고 작업하는 사람들과 꾸준히 소통하고 있습니다.
          </p>
          <div class="facts">
            <div class="fact"><strong>Role</strong><span>Architect / Creator</span></div>
            <div class="fact"><strong>Focus</strong><span>Design · Visualization · Education</span></div>
            <div class="fact"><strong>Tools</strong><span>SketchUp · D5 Render · Photoshop</span></div>
            <div class="fact"><strong>Instagram</strong><span>@agit_goyo</span></div>
          </div>
        </div>
        <div class="profile-visual">
          <img class="profile-image" src="/images/profile-goyo.jpg" alt="GOYO 프로필 이미지" />
    ...
    <section id="contact" class="contact">
      <div class="wrap">
        <div class="contact-box">
          ...
          <div>
            <p>
              설계 작업, 렌더 외주, 강의, 콘텐츠 협업까지 열려 있습니다.
              다루고 싶은 프로젝트가 있다면 편하게 연락 주세요.
            </p>
            <div class="contact-links">
              <a class="btn primary" href="mailto:agit.goyo@gmail.com">메일 보내기</a>
              <a class="btn" href="https://www.instagram.com/agit_goyo/" target="_blank" rel="noreferrer">인스타그램</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer>
    <div class="wrap footer-inner">
      ...
      <div class="footer-business">
        <strong>상호명</strong> 고요스튜디오 | <strong>대표자</strong> 한인용 | <strong>사업자등록번호</strong> 392-02-04286
        <br />
        <strong>사업장 주소</strong> 경기도 수원시 장안구 천천로22번길 34, 517동 1701호 (정자동, 백설마을삼환나우빌아파트)
        <br />
        <strong>업태</strong> 교육서비스업, 도매 및 소매업, 전문, 과학 및 기술서비스업 |
        <strong> 종목</strong> 온라인 교육학원, 전자상거래 소매업, 시각 디자인업
      </div>
    </div>
  </footer>
</body>
<script>
  (() => {
    ...
    const source = new EventSource(protocol + "://" + window.location.host + "/__preview/events");
...
function broadcastReload(changedPath) {
  for (const client of liveReloadClients) {
    ...
    client.write(`data: ${JSON.stringify({ changedPath })}\n\n`);
  }
}
...
function watchPath(targetPath) {
  ...
  try {
    fs.watch(targetPath, { recursive: true }, (_, filename) => {
      if (!filename) {
        broadcastReload(targetPath);
        return;
      }

      const changedPath = path.join(targetPath, filename.toString());
      if (changedPath.includes(".git") || changedPath.includes(".next")) {
        return;
      }
    ...
    console.warn(`Watch setup skipped for ${targetPath}: ${error.message}`);
  }
}
...
server.listen(port, host, () => {
  ...
  console.log("Live reload watching: app, public, package.json");
});
